...
struct mntopt mopts[] = {
    ...
    { "ping_diskarb",        1, FUSE_MOPT_PING_DISKARB,           1 }, // kused
...
static int
ping_diskarb(char *mntpath, __unused uint64_t altflags)
{
    int ret;
    struct statfs sb;
    enum {
...
main(int argc, char **argv)
{
    ...
    int32_t   dindex    = -1;
    char     *fdnam     = NULL;
    uint64_t  altflags  = 0ULL | FUSE_MOPT_PING_DISKARB;
    char     *mntpath   = NULL;
